...
* Create a table with a double logical operator
...
* Create a table with data from Austin and Galveston, using only the last three years of the dataset. Group the sales by county and then calculate zscores for each county.
